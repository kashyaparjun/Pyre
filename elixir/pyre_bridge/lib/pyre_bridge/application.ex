defmodule PyreBridge.Application do
  ...
  def start(_type, _args) do
    ...
    children = [
      ...
      {Task.Supervisor,
       name: PyreBridge.BridgeConnectionSupervisor, max_children: connection_worker_limit},
      {Task.Supervisor,
       name: PyreBridge.BridgeExecutionSupervisor, max_children: execution_worker_limit},
      {PyreBridge.BridgeWorkerPool, []},
