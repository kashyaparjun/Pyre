...
- Added `pyre-agents[pydantic-ai]` and `pyre-agents[crewai]` optional-deps extras.
- Added runnable examples in `examples/pydantic_ai_resilient.py` and `examples/crewai_resilient.py`.
